...
describe('directive: ma-dashboard-panel', function () {
    ...
    angular.module('testapp_state', []).filter('translate', function () {
    ...
    angular.module('testapp_DashboardPanel', ['testapp_state']).directive('maDashboardPanel', directive);
...
//# sourceMappingURL=maDashboardPanelSpec.js.map