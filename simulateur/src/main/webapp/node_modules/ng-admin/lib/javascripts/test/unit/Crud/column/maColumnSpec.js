...
describe('directive: ma-column', function () {
    ...
    angular.module('testapp_Column', []).directive('maColumn', directive).service('FieldViewConfiguration', function () {
        return {string: {getReadWidget: function getReadWidget() {
                    return 'DUMMY';
                }}};
        ...
        return {};
    }).service('NgAdminConfiguration', function () {
        return {};
    });
    ...
    it("should render the ReadWidget from the fieldView Configuration for that type", function () {
        ...
        scope.entity = {isReadOnly: false, editionView: function editionView() {
                return {enabled: true};
            }};
...
//# sourceMappingURL=maColumnSpec.js.map