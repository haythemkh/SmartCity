...
describe('directive: ma-menu-bar', function () {
    ...
    angular.module('testapp_MenuBar', []).filter('translate', function () {
    ...
    it('should autoClose menu when autoClose is true', function () {
        ...
        var blogMenu = new Menu(blog).title('blog').addChild(postMenu).addChild(commentMenu);
        var statsMenu = new Menu(stats).title('stats').link('/stats');
        var otherMenu = new Menu(other).title('other').addChild(statsMenu).addChild(tagMenu);
        scope.menu = new Menu().autoClose(true).addChild(blogMenu).addChild(otherMenu);
    ...
    it('should not autoClose menu when autoClose is true', function () {
        ...
        var statsMenu = new Menu(stats).title('stats').link('/stats');
        var otherMenu = new Menu(other).title('other').addChild(statsMenu).addChild(tagMenu);
        scope.menu = new Menu().autoClose(false).addChild(blogMenu).addChild(otherMenu);
...
//# sourceMappingURL=maMenuBarSpec.js.map