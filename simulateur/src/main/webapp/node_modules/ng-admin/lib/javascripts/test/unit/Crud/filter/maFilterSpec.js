...
describe('directive: ma-filter', function () {
    ...
    angular.module('testapp_Filter', []).directive('maFilter', directive).service('FieldViewConfiguration', function () {
        return {string: {getFilterWidget: function getFilterWidget() {
                    return 'DUMMY';
                }}};
    });
...
//# sourceMappingURL=maFilterSpec.js.map