...
describe('directive: choices-field', function () {
    ...
    angular.module('testapp_ChoicesField', ['ui.select', 'testapp_DataStore']).filter('translate', function () {
    ...
    it("should contain the choices as options", function () {
        scope.field = new ChoicesField().choices([{label: 'foo', value: 'bar'}, {label: 'baz', value: 'bazValue'}]);
    ...
    it("should have the option with the bounded value selected", function () {
        scope.field = new ChoicesField().choices([{label: 'foo', value: 'fooValue'}, {label: 'bar', value: 'barValue'}, {label: 'baz', value: 'bazValue'}]);
        ...
        var uiSelect = angular.element(element.children()[0]).controller('uiSelect');
        expect(angular.toJson(uiSelect.selected)).toEqual(JSON.stringify([{label: 'foo', value: 'fooValue'}, {label: 'baz', value: 'bazValue'}]));
    });
});
//# sourceMappingURL=maChoicesFieldSpec.js.map