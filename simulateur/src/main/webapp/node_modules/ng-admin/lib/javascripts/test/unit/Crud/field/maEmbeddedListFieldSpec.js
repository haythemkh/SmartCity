...
describe('directive: ma-embedded-list-field', function () {
    ...
    angular.module('testapp_EmbeddedListField', []).directive('translate', function () {
        return {
            restrict: 'A',
            scope: {translate: '@'},
            template: '{{ translate }}'
        };
    }).directive('maEmbeddedListField', directive).directive('maField', function () {
        return {
            scope: {value: '='},
    ...
    it('should contain a list of subforms with bounded inputs', function () {
        scope.field = new EmbeddedListField('dummy').targetFields([new Field('num'), new Field('name')]);
...
//# sourceMappingURL=maEmbeddedListFieldSpec.js.map