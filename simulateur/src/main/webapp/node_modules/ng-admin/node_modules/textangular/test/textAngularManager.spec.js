    ...
    describe('toolbar', function () {
        describe('registration', function () {
            ...
            it('should require a name', inject(function (textAngularManager) {
                expect(function () {
                    textAngularManager.registerToolbar({});
                }).toThrow("textAngular Error: A toolbar requires a name");
                expect(function () {
                    textAngularManager.registerToolbar({name: ''});
                }).toThrow("textAngular Error: A toolbar requires a name");
            }));
            ...
            it('should require a unique name', inject(function (textAngularManager) {
                ...
                expect(function () {
                    textAngularManager.registerToolbar({name: 'test'});
                }).toThrow('textAngular Error: A toolbar with name "test" already exists');
            }));
        });
    ...
    describe('editor', function () {
        describe('registration', function () {
            it('should require a name', inject(function (textAngularManager) {
                ...
                expect(function () {
                    textAngularManager.registerEditor('');
                }).toThrow("textAngular Error: An editor requires a name");
            }));

            it('should require a scope object', inject(function (textAngularManager) {
                expect(function () {
                    textAngularManager.registerEditor('test');
                }).toThrow("textAngular Error: An editor requires a scope");
            }));
            ...
            it('should require a unique name', inject(function (textAngularManager) {
                ...
                expect(function () {
                    textAngularManager.registerEditor('test', {});
                }).toThrow('textAngular Error: An Editor with name "test" already exists');
            }));
            ...
            describe('actions passthrough', function () {
                ...
                beforeEach(inject(function (taRegisterTool, taOptions, _$rootScope_, _$compile_) {
                    ...
                    taRegisterTool('activeonrangyrange', {
                        ...
                        commandKeyCode: 21,
                        activeState: function (rangyrange) {
                            return rangyrange !== undefined;
                        }
                    });
        ...
        describe('updating', function () {
            ...
            it('should throw error for named editor that doesn\'t exist', inject(function (textAngularManager) {
                expect(function () {
                    textAngularManager.refreshEditor('non-editor');
                }).toThrow('textAngular Error: No Editor with name "non-editor" exists');
            }));
