    ...
    <body>
        <div id="ng-app" ng-app="textAngularDemo" ng-controller="demoController" class="ng-scope">
            ...
            <div class="container text-right">
                <span class="well btn-md"><b>//cdnjs.cloudflare.com/ajax/libs/textAngular/<%= version %>/textAngular.min.js</b></span>&nbsp;&nbsp;&nbsp;
                <a href="https://github.com/fraywing/textAngular/archive/v<%= version %>.zip" class="btn btn-danger btn-lg">
                    <div><i class="icon-arrow-down"> </i><span>Download v<%= version %></span></div>
                </a>
            </div>
            <br>
            <div class="container border-around text-center lighter">
