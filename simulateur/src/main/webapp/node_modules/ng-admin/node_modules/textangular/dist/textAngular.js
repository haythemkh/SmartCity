                    ...
                    return {
                        ...
                        link: function (scope, element, attrs, controller) {
                            ...
                            if (!ngModelOptions.$options)
                                ngModelOptions.$options = {}; // ng-model-options support
                            ...
                            scope['$undoManager' + (attrs.id || '')] = ngModel.$undoManager = {
                                ...
                                push: function (value) {
                                    if ((typeof value === "undefined" || value === null) ||
                                            ((typeof this.current() !== "undefined" && this.current() !== null) && value === this.current()))
                                        return value;
                            ...
                            var _setViewValue = function (_val, triggerUndo, skipRender) {
                                ...
                                if (typeof triggerUndo === "undefined" || triggerUndo === null)
                                    triggerUndo = true && _isContentEditable; // if not contentEditable then the native undo/redo is fine
