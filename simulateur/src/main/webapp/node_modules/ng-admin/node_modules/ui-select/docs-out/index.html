                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <section id="examples">
                            ...
                            <h4><a href="./demo-append-to-body.html">Append To Body</a> <plnkr-opener example-path="demo-append-to-body.html"></plnkr-opener></h4>
                            <h4><a href="./demo-basic.html">Basic</a> <plnkr-opener example-path="demo-basic.html"></plnkr-opener></h4>
                            <h4><a href="./demo-bind-to-single-property-async.html">Bind To Single Property Async</a> <plnkr-opener example-path="demo-bind-to-single-property-async.html"></plnkr-opener></h4>
                            <h4><a href="./demo-bind-to-single-property.html">Bind To Single Property</a> <plnkr-opener example-path="demo-bind-to-single-property.html"></plnkr-opener></h4>
                            <h4><a href="./demo-bootstrap.html">Bootstrap</a> <plnkr-opener example-path="demo-bootstrap.html"></plnkr-opener></h4>
                            <h4><a href="./demo-disable-search.html">Disable Search</a> <plnkr-opener example-path="demo-disable-search.html"></plnkr-opener></h4>
                            <h4><a href="./demo-dropdown-position.html">Dropdown Position</a> <plnkr-opener example-path="demo-dropdown-position.html"></plnkr-opener></h4>
                            <h4><a href="./demo-event-on-selection.html">Event On Selection</a> <plnkr-opener example-path="demo-event-on-selection.html"></plnkr-opener></h4>
                            <h4><a href="./demo-focus.html">Focus</a> <plnkr-opener example-path="demo-focus.html"></plnkr-opener></h4>
                            <h4><a href="./demo-group-by.html">Group By</a> <plnkr-opener example-path="demo-group-by.html"></plnkr-opener></h4>
                            <h4><a href="./demo-group-filter.html">Group Filter</a> <plnkr-opener example-path="demo-group-filter.html"></plnkr-opener></h4>
                            <h4><a href="./demo-multiple-selection.html">Multiple Selection</a> <plnkr-opener example-path="demo-multiple-selection.html"></plnkr-opener></h4>
                            <h4><a href="./demo-object-as-source.html">Object As Source</a> <plnkr-opener example-path="demo-object-as-source.html"></plnkr-opener></h4>
                            <h4><a href="./demo-select2-with-bootstrap.html">Select 2 With Bootstrap</a> <plnkr-opener example-path="demo-select2-with-bootstrap.html"></plnkr-opener></h4>
                            <h4><a href="./demo-selectize-with-bootstrap.html">Selectize With Bootstrap</a> <plnkr-opener example-path="demo-selectize-with-bootstrap.html"></plnkr-opener></h4>
                            <h4><a href="./demo-tagging.html">Tagging</a> <plnkr-opener example-path="demo-tagging.html"></plnkr-opener></h4>
                        </section>
                    </div>
                </div>
            </div><!-- /.container -->
