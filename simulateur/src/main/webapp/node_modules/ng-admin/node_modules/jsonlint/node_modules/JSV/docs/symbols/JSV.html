...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        ...
        <div id="content">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="nameDescription" >
                            ...
                            <div class="description">A globaly accessible object that provides the ability to create and manage Environments,
                                as well as providing utility methods.</div>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="summaryTable" cellspacing="0" summary="A summary of the utility methods documented in the class JSV.">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="attributes">&lt;static&gt; &nbsp;</td>
                        <td class="nameDescription">
                            <div class="fixedFont">JSV.<b><a href="../symbols/JSV.html#.event:popFirst">popFirst</a></b>(arr, o)
                            </div>
                            <div class="description">Mutates the array by removing the first item that matches the provided value in the array.</div>
                        </td>
                    </tr>
            ...
            <div class="description">
                Creates and returns a new <a href="../symbols/Environment.html">Environment</a> that is a clone of the environment registered with the provided ID.
            ...
            <a name=".event:popFirst"> </a>
            <div class="fixedFont">&lt;static&gt; 

                <span class="light">{Array}</span>
                <span class="light">JSV.</span><b>popFirst</b>(arr, o)
