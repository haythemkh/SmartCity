...
function publish(symbolSet) {
    ...
    try {
        //var styleTemplate = new JSDOC.JsPlate(publish.conf.templatesDir+publish.conf.cssDir+"all.css");
    ...
    IO.copyFile(publish.conf.templatesDir + "/" + publish.conf.jsDir + "wbos.csstools.mediaqueryfallback.js", publish.conf.outDir + "/" + publish.conf.jsDir);
