...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <title>JsDoc Reference - InitializationError</title>
    ...
    <body>
        ...
        <div id="content">
            ...
            <table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class InitializationError.">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="nameDescription" >
                            <div class="fixedFont">
                                <b><a href="../symbols/InitializationError.html#constructor">InitializationError</a></b>(instance, schema, attr, message, details)
                            </div>
                            <div class="description">The exception that is thrown when a schema fails to be created.</div>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="details"><a name="constructor"> </a>
                ...
                <div class="fixedFont">
                    <b>InitializationError</b>(instance, schema, attr, message, details)
                </div>
                ...
                <dl class="detailList">
                    ...
                    <dt>
                        <span class="light fixedFont">{<a href="../symbols/JSONInstance.html">JSONInstance</a>|String}</span>  <b>instance</b>

                    </dt>
                    <dd>The instance (or instance URI) that is invalid</dd>

                    <dt>
                        <span class="light fixedFont">{<a href="../symbols/JSONSchema.html">JSONSchema</a>|String}</span>  <b>schema</b>

                    </dt>
                    <dd>The schema (or schema URI) that was validating the instance</dd>
