...
(function (mod) {
    ...
    CodeMirror.defineMode("javascript", function (config, parserConfig) {
        ...
        function statement(type, value) {
            ...
            if (type == "switch")
                return cont(pushlex("form"), parenExpr, pushlex("}", "switch"), expect("{"),
                        block, poplex, poplex);
            if (type == "case")
            ...
            if (type == "module")
                return cont(pushlex("form"), pattern, pushlex("}"), expect("{"), block, poplex, poplex)
            if (type == "type")
