...
(function (mod) {
    ...
    function SearchCursor(doc, query, pos, caseFold) {
        ...
        this.doc = doc;
        if (caseFold == null && typeof query == "string")
            caseFold = false;
        ...
        if (typeof query != "string") { // Regexp match
            ...
            this.matches = function (reverse, pos) {
                if (reverse) {
                    ...
                    if (start + matchLen != line.length && !matchLen)
                        matchLen = 1;
                }
                if (match && matchLen)
                ...
                this.matches = function (reverse, pos) {
                    ...
                    if (reverse) {
                        if (pos.line - (target.length - 1) < doc.firstLine())
                            return;
                        if (fold(doc.getLine(pos.line).slice(0, origTarget[last].length)) != target[target.length - 1])
                            return;
                        ...
                        for (var ln = pos.line + 1, i = 1; i < last; ++i, ++ln)
                            if (target[i] != fold(doc.getLine(ln)))
                                return;
                        if (fold(doc.getLine(ln).slice(0, origTarget[last].length)) != target[last])
                            return;
        ...
        find: function (reverse) {
            ...
            for (; ; ) {
                ...
                if (reverse) {
                    ...
                    if (pos.line == maxLine - 1)
                        return savePosAndFail(maxLine);
